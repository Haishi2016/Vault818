...
- **HelloWorld-ProtoActor** Hello, World! from [Proto Actor](http://proto.actor/). ![C# 7.0](./imgs/c-sharp-7.png)
...
- **DigitClassifier** implements a simple neuron network that recognize handwritten digits. ![C# 7.0](./imgs/c-sharp-7.png)
